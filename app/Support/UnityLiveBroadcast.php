...
final class UnityLiveBroadcast
{
    ...
    public static function payloadFor(
        ...
        return [
            ...
            'meetingSessionKey' => (int) ((is_array($livestream->settings) ? $livestream->settings : [])['meeting_session'] ?? 0),
            'reason' => $reason,
    ...
    public static function hostDashboardPayload(
        ...
        return [
            ...
            'livestream' => [
                ...
                'canGoLive' => $canGoLive,
                'streamingQueueStatus' => $streamingQueue->queueStatusForUi($latestJob, $livestream, false),
