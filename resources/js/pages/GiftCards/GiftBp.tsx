            ...
            <div className="rounded-3xl border border-purple-500/15 bg-gradient-to-b from-purple-600/[0.06] to-transparent p-5 dark:from-purple-500/10">
              ...
              <ol className="mt-3 space-y-3 text-sm text-muted-foreground">
                ...
                <li className="flex gap-2.5">
                  ...
                  <span>Closed-loop gift cards use Available BP (Gift reporting decreases). Visa/Mastercard open-loop cards are a Prime Supporter benefit paid with Believe Cash balance.</span>
                </li>
              </ol>
            </div>
