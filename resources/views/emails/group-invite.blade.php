...
<body style="margin:0;padding:0;background:#f4f6fb;font-family:Arial,Helvetica,sans-serif;color:#1e293b;">
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#f4f6fb;padding:24px 12px;">
        <tr>
            <td align="center">
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;background:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #e9d5ff;">
                    <tr>
                        <td style="padding:28px 28px 20px;background:linear-gradient(90deg,#9333ea,#2563eb);color:#ffffff;">
                            ...
                            <h1 style="margin:0;font-size:24px;line-height:1.3;">You're invited</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:28px;">
                            <p style="margin:0 0 16px;font-size:16px;line-height:1.6;">
                                ...
                                <strong>{{ $groupName }}</strong> on {{ $appName }}.
                            </p>
                            <p style="margin:0 0 24px;font-size:14px;line-height:1.6;color:#64748b;">
                                Accept the invite to become a member and start participating in discussions, polls, and more.
                            </p>
                            <a href="{{ $acceptUrl }}"
