...
class GiftCardRevenueShareServiceTest extends TestCase
{
    ...
    public function test_ledger_meta_includes_optional_supporter_tip(): void
    {
        $meta = GiftCardRevenueShareService::ledgerMetaSlice(25.0, 2.0, 0.2, 1.8, 0.0, null, 0.50);

        $this->assertSame(25.0, $meta['gift_card_sales']);
        $this->assertEqualsWithDelta(0.0, $meta['platform_fee'], 0.0001);
        $this->assertEqualsWithDelta(0.50, $meta['supporter_tip'], 0.0001);
        $this->assertEqualsWithDelta(0.50, $meta['supporter_tip_org_share'], 0.0001);
        $this->assertEqualsWithDelta(0.0, $meta['biu_fee'], 0.0001);
        ...
        $this->assertEqualsWithDelta(0.2, $meta['platform_payout'], 0.0001);
        $this->assertEqualsWithDelta(1.8, $meta['organization_revenue'], 0.0001);
        // Org: tip 0.50 + provider share 1.80
